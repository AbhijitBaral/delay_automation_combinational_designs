`timescale 1ns / 1ps
module RCA #(parameter M=20, K=12)(
	input [17:0]A,B,
	input Cin,
	output [17:0]sum,
	output Cout
...
.CO({dummyCO[1:0]  , carry[17:16]}),
.O ({dummySO[1:0]  , sum[17:16]}),
.CI(carry[15]),
.CYINIT(),
.DI({dummyDI[1:0], A[17:16]}),
.S ({dummyS[1:0] , Propagate[17:16]})
);

assign Cout=carry[18-1];
