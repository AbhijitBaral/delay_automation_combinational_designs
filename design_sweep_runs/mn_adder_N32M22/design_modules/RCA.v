`timescale 1ns / 1ps
module RCA #(parameter M=22, K=10)(
	input [18:0]A,B,
	input Cin,
	output [18:0]sum,
	output Cout
...
.CO({dummyCO[0:0]  , carry[18:16]}),
.O ({dummySO[0:0]  , sum[18:16]}),
.CI(carry[15]),
.CYINIT(),
.DI({dummyDI[0:0], A[18:16]}),
.S ({dummyS[0:0] , Propagate[18:16]})
);

assign Cout=carry[19-1];
