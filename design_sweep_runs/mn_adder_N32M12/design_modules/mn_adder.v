`timescale 1ns / 1ps
module mn_adder #(parameter N=32,M=12)(
	input [31:0] A,B,
	input Cin,
	output [31:0] sum,
	output Cout
...
(*RLOC_ORIGIN = "X1Y6" , KEEP_HIERARCHY="yes"*)compressed_adder #(.K(20)) compressed_adder_inst(.A(A[19:0]), .group_carry(group_carry), .B(B[19:0]), .Cin(Cin), .sum(sum[19:0]));
