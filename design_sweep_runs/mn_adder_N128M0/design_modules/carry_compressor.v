...
module carry_compressor #(parameter K=128)(
    input[127:0] A,B,
    input Cin,
    ...
    output [63:0]group_carry,
    output Cout
    );

//--------------------------------------------------------------
wire [63:0]group_propagate, group_generate;
//--------------------------------------------------------------
...
(*RLOC="X0Y15"*)LUT6_2 #(.INIT(64'h000006600000FAA0)) CC_lut126(
.O6(group_propagate[63]),
.O5(group_generate[63]),
.I0(A[126]),
.I1(B[126]),
.I2(A[127]),
.I3(B[127]),
...
(*RLOC = "X0Y15"*)CARRY4 CC_carry4_15(
.CO(group_carry[63:60]),
.O(),
.CI(group_carry[59]),
.CYINIT(),
.DI(group_generate[63:60]),
.S(group_propagate[63:60])
);
