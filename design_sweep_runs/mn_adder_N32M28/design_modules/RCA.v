...
.CO({dummyCO[1:0]  , carry[25:24]}),
.O ({dummySO[1:0]  , sum[25:24]}),
.CI(carry[23]),
.CYINIT(),
.DI({dummyDI[1:0], A[25:24]}),
.S ({dummyS[1:0] , Propagate[25:24]})
);

assign Cout=carry[26-1];
