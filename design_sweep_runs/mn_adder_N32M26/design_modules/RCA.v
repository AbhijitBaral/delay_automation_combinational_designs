...
.CO({dummyCO[2:0]  , carry[24:24]}),
.O ({dummySO[2:0]  , sum[24:24]}),
.CI(carry[23]),
.CYINIT(),
.DI({dummyDI[2:0], A[24:24]}),
.S ({dummyS[2:0] , Propagate[24:24]})
);

assign Cout=carry[25-1];
